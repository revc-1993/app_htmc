...
<template>
    <div
        class="flex min-h-screen items-center justify-center bg-cover bg-left-bottom bg-fixed"
        :class="colorClass"
        style="
            background-image: url('https://www.htmc.gob.ec/wp-content/uploads/2021/07/20210719-QUIROFANO-NO-1280x663.jpeg');
        "
    >
        ...
        <slot
            card-class="absolute max-h-screen-menu h-7/12 w-11/12 md:w-7/12 lg:w-6/12 xl:w-4/12 shadow-2xl"
        />
    </div>
</template>
