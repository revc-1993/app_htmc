...
const inputElClass = computed(() => {
    const base = [
        "flex w-full rounded-tl-lg rounded-bl-lg border-r px-3 py-2 max-w-full",
        props.disabled
            ? "text-slate-800 dark:text-slate-300 border-slate-400"
            : "border-slate-600 focus:ring-blue-400",
        props.hasErrors
            ? "border-red-600 focus:ring-red-600 dark:focus:ring-red-600 placeholder-red-400"
            : "border-gray-600",
        "dark:placeholder-gray-400",
        computedType.value === "textarea" ? "h-24 resize-none" : "h-12",
        props.borderless ? "border-0" : "border",
        props.transparent ? "bg-transparent" : "bg-white dark:bg-slate-700",
        "focus:outline-none focus:ring placeholder-slate-400 border-slate-600",
        "focus:ring-blue-400",
    ];
