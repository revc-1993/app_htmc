...
use App\FormRequestValidator\Payment\PaymentRoleValidatorFactory;
...
class UpdatePaymentRequest extends FormRequest
{
    ...
    {
        $this->roleValidator = PaymentRoleValidatorFactory::make($this->getCurrentRole(), $this->input(), $this->route('payment.id'));
